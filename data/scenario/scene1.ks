...
[chara_show  name="賽歐"  time="1000"  wait="true"  storage="chara/3/theo1.png"  width="470"  height="720"  left="100"  ]
[tb_start_text mode=1 ]
#賽歐
萊登，我這邊接好了喔——[p]
[_tb_end_text]

[chara_move  name="賽歐"  anim="true"  time="300"  effect="easeInQuad"  wait="true"  top="0"  left="-50"  width="470"  height="720"  ]
[chara_show  name="馬塞爾"  time="1000"  wait="true"  storage="chara/8/marcel1.png"  width="470"  height="720"  left="800"  top="0"  ]
[tb_start_text mode=1 ]
#馬塞爾
修迦，這邊也好了。[p]
[_tb_end_text]
...
[chara_show  name="萊登"  time="1000"  wait="true"  storage="chara/4/raiden1.png"  width="470"  height="720"  left="550"  ]
[tb_start_text mode=1 ]
#萊登
辛，你那邊呢？[p]
...
[chara_show  name="辛"  time="1000"  wait="true"  storage="chara/1/shin1.png"  width="470"  height="720"  left="250"  top="0"  reflect="false"  ]
[tb_start_text mode=1 ]
#辛
完成了。[p]
[_tb_end_text]
...
[chara_mod  name="辛"  time="600"  cross="false"  storage="chara/1/shin3_smile.png"  ]
[tb_start_text mode=1 ]
#辛
...
[tb_start_text mode=1 ]
#菲多
溫柔婉約笑著的艾瑪大人拿起一份漢堡包，並將餐盒交給坐在身邊的庫克米拉大人。[p]
[_tb_end_text]

[chara_show  name="蕾娜"  time="1000"  wait="true"  storage="chara/2/lena1.png"  width="470"  height="720"  left="200"  top="0"  reflect="false"  ]
[tb_start_text mode=1 ]
#蕾娜
哇⋯⋯好美喔⋯⋯⋯⋯[p]
...
[chara_show  name="阿涅塔"  time="1000"  wait="true"  storage="chara/7/anetta2_smile.png"  width="470"  height="720"  left="500"  ]
[tb_start_text mode=1 ]
#阿涅塔
真的全是粉紅色的，這真是太驚人了！[p]
[_tb_end_text]

[chara_show  name="可蕾娜"  time="1000"  wait="true"  storage="chara/5/kurena1.png"  width="470"  height="720"  left="800"  top=""  reflect="false"  ]
[tb_start_text mode=1 ]
#可蕾娜
阿涅塔沒有看過櫻花嗎？[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#菲多
各位大人們圍成一圈坐著，邊輕鬆的閒聊，邊將晚餐的漢堡包傳給身旁的夥伴。[p]
[_tb_end_text]
...
#安琪
好啦——[p]
大家都有漢堡包和飲料了吧，總之我們先來乾杯，然後開始吃東西吧。[p]
...
[tb_image_show  time="1000"  storage="default/hamburger.png"  width="192"  height="185"  x="751"  y="219"  _clickable_img=""  name="img_135"  ]
[tb_start_text mode=1 ]
#蕾娜
清爽不油膩的沙拉醬襯托出蝦子的甘甜，鬆軟的白麵包裡夾著鮮脆的生菜，讓口感增加了許多層次。[p]
主廚特製超級豪華賞花漢堡包真的好好吃喔。[p]
[_tb_end_text]
