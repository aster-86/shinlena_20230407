...
[tb_start_text mode=1 ]
#レーナ
アルコールの影響でレーナは理不尽になり、シンの説明でさえ受けつけず、さらにはその銀鈴の声でかなりの文句を言いつけた。[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#ファイド
ミリーゼ様はノウゼン様の弁解に一切耳を傾けず、いきなり立ち上がり、靴も履けず真っすぐに後方の空け地へと飛び出していった。[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#ファイド
果たして、突如に訪れた親しげな挙動でミリーゼ様の意識を少しでも取り戻せるのでしょうか？[p]
...
[tb_start_text mode=1 ]
#ファイド
例え距離は離れているとは言え、二人の間で繰り広げたその会話は完璧に耳に届いてしまっていました。[p]
